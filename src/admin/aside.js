...
class Aside extends HTMLElement {
    ...
    render() {
      ...
      .aside-item-header .delete-button {
        padding: 0 .5rem;
      }
      </style>
          ...
          (value) => `
            <div class="aside-item">
              ...
              <div class="aside-item-content">
                <div class="aside-email"><span>Email: ${value.email}</span></div>
                <div class="aside-name"><span>Name: ${value.name}</span></div>
                <div class="aside-surname"><span>Apellidos: ${value.surname}</span></div>
              </div>
            </div>
          `
        )
      ...
      `;
      const asideItems = this.shadowRoot.querySelectorAll(".aside-item-content");
        asideItems.forEach((asideItem, index) => {
        asideItem.querySelector('.aside-email').innerHTML = `Email: ${this.values[index].email}`;
        asideItem.querySelector('.aside-name').innerHTML = `Name: ${this.values[index].name}`;
